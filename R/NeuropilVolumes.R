...
vstats=NeuropilStats(dir(leaconfig$Dvir$FBIS1bridging.jacs,full=TRUE),mask=leaconfig$Dmel$IS1.2um.neuropilmask)
...
leaconfig$Dvir$DmelIS1.jacfiles=dir(leaconfig$Dvir$DmelIS1.jacs,full=T)
...
vstats=NeuropilStats(dir(leaconfig$Dsim$FBIS1bridging.jacs,full=TRUE),mask=leaconfig$Dmel$IS1.2um.neuropilmask)
...
leaconfig$Dsim$DmelIS1.jacfiles=dir(leaconfig$Dsim$DmelIS1.jacs,full=T)
